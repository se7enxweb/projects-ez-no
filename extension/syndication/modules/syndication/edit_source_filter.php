...
$Result['path'] = array( array( 'url' => false,
                                'text' => ezi18n( 'syndication/list', 'Syndication' ) ),
                         array( 'url' => false,
                                'text' => ezi18n( 'syndication/list', 'Edit' ) ),
                         array( 'url' => false,
                                'text' => ezi18n( 'syndication/list', 'Add Source' ) ),
                         array( 'url' => false,
                                'text' => ezi18n( 'syndication/list', 'Edit Filter' ) ) );
