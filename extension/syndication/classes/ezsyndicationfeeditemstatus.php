...
class eZSyndicationFeedItemStatus extends eZPersistentObject
{
    ...
    /*!
     Constructor
    */
    function eZSyndicationFeedItemStatus( $row = array() )
    {
    ...
    */
    ...
    {
        return array( eZSyndicationFeedItemStatus::STATUS_NONE => ezi18n( 'syndication', 'None' ),
                      eZSyndicationFeedItemStatus::STATUS_PENDING => ezi18n( 'syndication', 'Pending' ),
                      eZSyndicationFeedItemStatus::STATUS_INSTALLING => ezi18n( 'syndication', 'Installing' ),
                      eZSyndicationFeedItemStatus::STATUS_INSTALLED => ezi18n( 'syndication', 'Installed' ),
                      eZSyndicationFeedItemStatus::STATUS_FAILED => ezi18n( 'syndication', 'Failed' ),
                      eZSyndicationFeedItemStatus::STATUS_DENIED => ezi18n( 'syndication', 'Denied' ),
                      eZSyndicationFeedItemStatus::STATUS_DELETED => ezi18n( 'syndication', 'Deleted' ),
                      eZSyndicationFeedItemStatus::STATUS_IGNORED => ezi18n( 'syndication', 'Ignoring' ) );
    }
