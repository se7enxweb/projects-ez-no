...
class eZSyndicateType extends eZBooleanType
{
    /*!
     Constructor
    */
    function eZSyndicateType()
    {
        $this->eZDataType( EZ_DATATYPESTRING_STRING, ezi18n( 'kernel/classes/datatypes', 'Syndicate', 'Datatype name' ),
...
eZDataType::register( EZ_DATATYPESTRING_STRING, 'ezsyndicatetype' );
