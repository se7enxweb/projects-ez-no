...
Order confirmation from eZ Systems

Thank you for shopping at ez.no
...
{mul(sub($:item.price_inc_vat,$:item.price_ex_vat),sub(1,div($:item.discount_percent,100)))|l10n(currency)}
...
Should you have any questions, feel free to send an e-mail to info@ez.no
...
--
eZ Systems AS
Organisation number: 981 601 564 MVA
Mail: info@ez.no | Phone: (+ 47) 35 58 70 20
