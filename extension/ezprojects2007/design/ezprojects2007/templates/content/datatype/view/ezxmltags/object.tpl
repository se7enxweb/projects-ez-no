...
{section show=and( $object_align|ne(""), $object.contentclass_id|eq( "5" ))}
    <div class="object-{$object_align}{section show=ne($classification|trim,'')} {$classification|wash}{/section}">
        {content_view_gui view=$view object_parameters=$object_parameters attribute_parameters=$object_parameters link_parameters=$link_parameters content_object=$object}
    </div>
{section-else}
    {content_view_gui view=$view object_parameters=$object_parameters attribute_parameters=$object_parameters link_parameters=$link_parameters content_object=$object}
{/section}
