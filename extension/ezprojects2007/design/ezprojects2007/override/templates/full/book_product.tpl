...
{* We don't have shipping and handling for the eZ Publish basic PDF book. *}
{if $node.node_id|eq(115275)|not()}
    <p>{"(+ %cost for shipping and handling)"|i18n( "ezno/shop",,hash( "%cost", "$15.00"))}</p>    
{/if}
