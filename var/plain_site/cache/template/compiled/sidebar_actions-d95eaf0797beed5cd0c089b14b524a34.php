<?php
// URI:       extension/ezprojects2007/design/ezprojects2007/templates/parts/sidebar_actions.tpl
// Filename:  extension/ezprojects2007/design/ezprojects2007/templates/parts/sidebar_actions.tpl
// Timestamp: 1286250000 (Mon Oct 4 20:40:00 PDT 2010)
$oldSetArray_01c906a86546569526de6a23fd014f9f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( !isset( $vars[$currentNamespace]['showTrackChanges'] ) )
{
    $vars[$currentNamespace]['showTrackChanges'] = false;
    $setArray[$currentNamespace]['showTrackChanges'] = true;
}
...
unset( $if_cond3 );
unset( $if_cond3 );
$if_cond3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'showTrackChanges', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['showTrackChanges'] : null;
...
unset( $if_cond4 );
$if_cond4 = $if_cond5;
$if_cond5 = compiledFetchAttribute( $if_cond4, 'can_edit' );
unset( $if_cond4 );
$if_cond4 = $if_cond5;
...
$if_cond6 = compiledFetchAttribute( $if_cond5, 'object' );
unset( $if_cond5 );
$if_cond5 = $if_cond6;
$if_cond6 = compiledFetchAttribute( $if_cond5, 'can_remove' );
unset( $if_cond5 );
$if_cond5 = $if_cond6;
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'showTrackChanges', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['showTrackChanges'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
if ( isset( $setArray[$currentNamespace]['showTrackChanges'] ) )
{
unset( $vars[$currentNamespace]['showTrackChanges'] );
}


$setArray = $oldSetArray_01c906a86546569526de6a23fd014f9f;
$tpl->Level--;
?>
