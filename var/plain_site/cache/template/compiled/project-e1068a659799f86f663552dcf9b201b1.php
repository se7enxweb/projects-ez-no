...
$oldSetArray_7d7631980679a6e92100a3be854cc915 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$nod_7d7631980679a6e92100a3be854cc915 = $object->attribute( 'data_map' );
else
$nod_7d7631980679a6e92100a3be854cc915 = false;
unset( $node, $object );
...
unset( $var );
unset( $var1 );
$var1 = $nod_7d7631980679a6e92100a3be854cc915;
if ( !$var1 )
{
unset( $var1 );
...
<tr class="bglight">
    <td>';
unset( $var );
$var = $nod_7d7631980679a6e92100a3be854cc915;
if ( !$var )
{
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
...
$text .= '    <td>';
$oldRestoreIncludeArray_5ed88edd8edc7f5bdcabef7114b8300f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/status-e507f6e98cf51267317f717701bf22df.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/status-e507f6e98cf51267317f717701bf22df.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_5ed88edd8edc7f5bdcabef7114b8300f;
...
$text .= '    <td>
    ';
unset( $show );
$show = $nod_7d7631980679a6e92100a3be854cc915;
if ( !$show )
{
unset( $show );
...
';
$oldRestoreIncludeArray_0400b466d3a7b19378b5ca24b12ab161 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/sidebar_actions-6dc60936c4c5b2b7036e321a531cf412.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/plain_site/cache/template/compiled/sidebar_actions-6dc60936c4c5b2b7036e321a531cf412.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0400b466d3a7b19378b5ca24b12ab161;
...
$setArray = $oldSetArray_7d7631980679a6e92100a3be854cc915;
$tpl->Level--;
?>
