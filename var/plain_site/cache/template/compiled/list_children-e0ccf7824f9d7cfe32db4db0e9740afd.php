<?php
// URI:       extension/ezprojects2007/design/ezprojects2007/templates/parts/list_children.tpl
// Filename:  extension/ezprojects2007/design/ezprojects2007/templates/parts/list_children.tpl
// Timestamp: 1286250000 (Mon Oct 4 20:40:00 PDT 2010)
$oldSetArray_b4449d96756fc877f7e07c3f75fbb9e6 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
';
$vars[$currentNamespace]['sequence_value'] = array (
);
$vars[$currentNamespace]['used_node'] = true;
unset( $show );
unset( $show1 );
unset( $show1 );
$show1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'sequence', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['sequence'] : null;
...
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'sequence_value', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['sequence_value'] = $var;
    unset( $var );
}
}
...
unset( $sequence );
unset( $sequence );
$sequence = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'sequence_value', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['sequence_value'] : null;
if (! isset( $sequence ) ) $sequence = NULL;
while ( is_object( $sequence ) and method_exists( $sequence, 'templateValue' ) )
    $sequence = $sequence->templateValue();
...
$oldRestoreIncludeArray_c89adfcd70cd55bfadf288488fb14c2a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'child_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['child_count'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$namespace = $currentNamespace;
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/google-d3788f95b593f3193443117f4e4eeaaa.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/plain_site/cache/template/compiled/google-d3788f95b593f3193443117f4e4eeaaa.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_c89adfcd70cd55bfadf288488fb14c2a;

$text .= '
';
unset( $vars[$currentNamespace]['sequence_value'] );
unset( $vars[$currentNamespace]['used_node'] );

$setArray = $oldSetArray_b4449d96756fc877f7e07c3f75fbb9e6;
$tpl->Level--;
?>
