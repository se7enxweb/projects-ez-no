...
$oldSetArray_81e9261f67707e6ad423a70f65a5185b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/review-39c8b8248cad5e7df7e378ff10e5707e.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/review-39c8b8248cad5e7df7e378ff10e5707e.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/rss_import-0926dd46a04cc6a2bca9d3bc1b7f257c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/rss_import-0926dd46a04cc6a2bca9d3bc1b7f257c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/article-56d9799e620ddc6f889cc50f08f6ad18.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/article-56d9799e620ddc6f889cc50f08f6ad18.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/comment-febb4176c25f5bb89d8542ed89c0f8fa.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/comment-febb4176c25f5bb89d8542ed89c0f8fa.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/article_container-e49bdd3b83a723331dbcd254a79086b1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/article_container-e49bdd3b83a723331dbcd254a79086b1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/product-2ebb8b2876e4205f71f44838ce2c4839.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/product-2ebb8b2876e4205f71f44838ce2c4839.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/bug-05a2073a8832dd243156c0db88f3e7e6.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/bug-05a2073a8832dd243156c0db88f3e7e6.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/contrib_category-777e5655cf46f817a0005469c56fae03.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/contrib_category-777e5655cf46f817a0005469c56fae03.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/project-0dbc856661a915e83b60f1eb9a8715e3.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/project-0dbc856661a915e83b60f1eb9a8715e3.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/employee-535848d1837d870918c8b83f614a44a0.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/employee-535848d1837d870918c8b83f614a44a0.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/exam-7db1c824ffaad546006848dfd32097fa.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/exam-7db1c824ffaad546006848dfd32097fa.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/file-88a379cd7547c9e5610d5c7c1b4932f1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/file-88a379cd7547c9e5610d5c7c1b4932f1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/flash-39a4b2891b8fae157ac1640be51e01f0.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/flash-39a4b2891b8fae157ac1640be51e01f0.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/infopage-ec548a3e2101e5882cd846dc705f37f7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/infopage-ec548a3e2101e5882cd846dc705f37f7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/image_gallery-a6370e579e465b561b9685af995f2854.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/image_gallery-a6370e579e465b561b9685af995f2854.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/log-3a39f1c5d4a909c980e202f090d8787b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/log-3a39f1c5d4a909c980e202f090d8787b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/faq_category-f9fe4ddad931da62569a046f380b52d8.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/faq_category-f9fe4ddad931da62569a046f380b52d8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/forum-a34aec47468b410bd3ba246c3d83cc44.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/forum-a34aec47468b410bd3ba246c3d83cc44.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/forum_message-eab16afc81b14cb5595809194f8a6239.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/forum_message-eab16afc81b14cb5595809194f8a6239.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/partner-b326e853442fe5255676a46678f5642a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/partner-b326e853442fe5255676a46678f5642a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/presentation-6c916ae2cd426ecd42523cf78f854f32.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/presentation-6c916ae2cd426ecd42523cf78f854f32.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/question-dc300b4034e0f421736c2b11eefc79a5.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/question-dc300b4034e0f421736c2b11eefc79a5.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/reference-665568450c908abcb627c40bf8d96d38.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/reference-665568450c908abcb627c40bf8d96d38.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/specification-4eccf8b6e5aac105e95a650649a6f63a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/specification-4eccf8b6e5aac105e95a650649a6f63a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/template_mechanism-be1b918c69ad68704595adeedd29d82d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/template_mechanism-be1b918c69ad68704595adeedd29d82d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/user_groups-c2852ca93024cff493cefa9534b2ec74.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/user_groups-c2852ca93024cff493cefa9534b2ec74.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/line-f7179e1bd56db7b4b857b3687e8cff1f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/line-f7179e1bd56db7b4b857b3687e8cff1f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/review-1261e71cf56a064f10aa7e2e16395873.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/review-1261e71cf56a064f10aa7e2e16395873.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/article-522c03f5f8d5936ca6b47590e66411ec.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/article-522c03f5f8d5936ca6b47590e66411ec.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/rss_import-4827b0fe8402b1857d7224ca1d79190a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/rss_import-4827b0fe8402b1857d7224ca1d79190a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/comment-30a6f4a5d7a43b9c74c281b579659948.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/comment-30a6f4a5d7a43b9c74c281b579659948.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/article_container-6bf7acdbba68a2ed1a9b9a737a924f74.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/article_container-6bf7acdbba68a2ed1a9b9a737a924f74.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/project-882976345010cba9b164b069f04dde20.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/project-882976345010cba9b164b069f04dde20.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/forum_message-bedb224071690b7f6cb74ceb43f51055.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/forum_message-bedb224071690b7f6cb74ceb43f51055.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/log-2258e7e9ab52517fb327f33d63d244df.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/log-2258e7e9ab52517fb327f33d63d244df.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/specification-bc206cf96d9d3f00405ec42ee964dc6c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/specification-bc206cf96d9d3f00405ec42ee964dc6c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/listitem-216bc7fb22ef09033a55382eebff3915.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/plain_site/cache/template/compiled/listitem-216bc7fb22ef09033a55382eebff3915.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$text .= '<p>You need to be logged in to add a new project. You can do so <a href="/user/login">here</a>.</p>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_81e9261f67707e6ad423a70f65a5185b;
$tpl->Level--;
?>
