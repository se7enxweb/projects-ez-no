...
$oldSetArray_a6d5d810e8d05bb6a1fd14a76da63fc0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$nod_a6d5d810e8d05bb6a1fd14a76da63fc0 = $object->attribute( 'data_map' );
else
$nod_a6d5d810e8d05bb6a1fd14a76da63fc0 = false;
unset( $node, $object );
...
unset( $var );
unset( $var1 );
$var1 = $nod_a6d5d810e8d05bb6a1fd14a76da63fc0;
if ( !$var1 )
{
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
...
$text .= '   
   ';
$oldRestoreIncludeArray_8daa0c4803d65e27bbc1f0d4120d5b8c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
unset( $var );
$var = $nod_a6d5d810e8d05bb6a1fd14a76da63fc0;
if ( !$var )
{
unset( $var );
...
$restoreIncludeArray = $oldRestoreIncludeArray_8daa0c4803d65e27bbc1f0d4120d5b8c;
...
$setArray = $oldSetArray_a6d5d810e8d05bb6a1fd14a76da63fc0;
$tpl->Level--;
?>
