...
$oldSetArray_098aa47b799fa1207c4376ccab0f5af9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div id="logo">
<h1><a href="/"><span class="hide">eZ Systems</span></a></h1>
</div>
...
<hr class="hide" />
';
$oldRestoreIncludeArray_9a9b5eb0556679f79000673bd47d2c40 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/searchbox-87dc8a91678085b99bd0f0b12b1a1c94.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/searchbox-87dc8a91678085b99bd0f0b12b1a1c94.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_9a9b5eb0556679f79000673bd47d2c40;
...
$text .= '        <li><a href="/notification/settings">Notification settings</a></li>
        <li><a href="/collaboration/view/summary">Collaboration</a></li>
...
$text .= '        <li><a href="/redirect/profile">My profile</a></li>
...
$text .= '        <li><a href="/user/login">Log in</a></li>
    ';
}
...
<!-- Header area: END -->
';
$oldRestoreIncludeArray_f103d17de984d2614d7570fae3ac318f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/mainmenu-11099ec8251adda82e211bf585d0542b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/mainmenu-11099ec8251adda82e211bf585d0542b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f103d17de984d2614d7570fae3ac318f;
...
$setArray = $oldSetArray_098aa47b799fa1207c4376ccab0f5af9;
$tpl->Level--;
?>
