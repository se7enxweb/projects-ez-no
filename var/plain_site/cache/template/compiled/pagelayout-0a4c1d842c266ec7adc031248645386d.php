...
$oldSetArray_0d256baeb2b2eefb151901a0bd090067 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<hr class="hide" />
';
$oldRestoreIncludeArray_702cb83ae84aa89d7483970bc9354b92 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/searchbox-45e2214bbebe3d09dc35b1763dea586c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/searchbox-45e2214bbebe3d09dc35b1763dea586c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_702cb83ae84aa89d7483970bc9354b92;
...
<!-- Header area: END -->
';
$oldRestoreIncludeArray_6b17f1f6dbe7a40b2e1ef6e6dfae77cd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/mainmenu-e3517688b7c40e3b483ce6070571c6ea.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/mainmenu-e3517688b7c40e3b483ce6070571c6ea.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_6b17f1f6dbe7a40b2e1ef6e6dfae77cd;
...
$setArray = $oldSetArray_0d256baeb2b2eefb151901a0bd090067;
$tpl->Level--;
?>
