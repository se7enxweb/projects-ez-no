...
$oldSetArray_435f989c8f54fa58f13e336b15960972 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$nod_435f989c8f54fa58f13e336b15960972 = $object->attribute( 'data_map' );
else
$nod_435f989c8f54fa58f13e336b15960972 = false;
unset( $node, $object );
...
unset( $var );
unset( $var1 );
$var1 = $nod_435f989c8f54fa58f13e336b15960972;
if ( !$var1 )
{
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
...
$text .= '   
   ';
$oldRestoreIncludeArray_e5299ce2eb79a4fa5ee31b0d5583d9fd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
unset( $var );
$var = $nod_435f989c8f54fa58f13e336b15960972;
if ( !$var )
{
unset( $var );
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/status-ededed2a275575bf827b5c3cdb78a71e.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/status-ededed2a275575bf827b5c3cdb78a71e.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_e5299ce2eb79a4fa5ee31b0d5583d9fd;
...
$setArray = $oldSetArray_435f989c8f54fa58f13e336b15960972;
$tpl->Level--;
?>
