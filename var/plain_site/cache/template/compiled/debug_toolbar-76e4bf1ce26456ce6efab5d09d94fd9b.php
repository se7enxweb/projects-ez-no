...
$oldSetArray_6c2b214b2719e74beeadd555c6b98ab4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div class="element">
<h3>Clear cache:</h3>';
$oldRestoreIncludeArray_52bf4d20cd1caf9c0894fe8368d06f16 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/clear_cache-0082f832c368aea281fae35ecdd32871.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/clear_cache-0082f832c368aea281fae35ecdd32871.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_52bf4d20cd1caf9c0894fe8368d06f16;
...
$oldRestoreIncludeArray_7557b0e7216aeeb042152b543dd102e3 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/quick_settings-0e930cfb56d0b295d3646fb3ef02ce4b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/quick_settings-0e930cfb56d0b295d3646fb3ef02ce4b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7557b0e7216aeeb042152b543dd102e3;
...
$setArray = $oldSetArray_6c2b214b2719e74beeadd555c6b98ab4;
$tpl->Level--;
?>
