...
$oldSetArray_e626ea4462d36b6deb4336765792ca20 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form action="/index.php/content/advancedsearch" method="get">
...
$setArray = $oldSetArray_e626ea4462d36b6deb4336765792ca20;
$tpl->Level--;
?>
